...
const SEED: AppNotification[] = [
  {
    ...
    description: "Hiring manager confirms readiness — Retail team member, VIC",
    timestamp: mins(4),
    actor: "Priya Nair",
  },
  {
    ...
    description: "Was due 3 days before start date for Dzaky Rosihan",
    timestamp: mins(90),
  },
  {
    id: "n3",
  ...
  },
  {
    ...
    description: "Welcome session and buddy pairing",
